...
snit::widget ::hv3::debug::tree {
	...
	ttk::button ${win}.buttons.expand \
	    -text "Expand All" -command [mymethod ExpandAll]
	ttk::button ${win}.buttons.collapse \
	    -text "Collapse All" -command [mymethod CollapseAll]
	pack ${win}.buttons.expand -side left
	pack ${win}.buttons.collapse -side left

	# The search widget.
	ttk::frame ${win}.search
	ttk::label  ${win}.search.label -text "Search:"
	ttk::entry  ${win}.search.entry
	ttk::button ${win}.search.forward -text ">" -state disabled \
	    -style Toolbutton
	ttk::button ${win}.search.back    -text "<" -state disabled \
	    -style Toolbutton
	ttk::label  ${win}.search.label2  -text "?/0"
...
snit::widget HtmlDebug {
  ...
  constructor {HTML} {
    ...
    ttk::panedwindow $win.hpan -orient vertical
    # ::hv3::debug::search $mySearch $HTML
    ttk::panedwindow $win.hpan.vpan -orient horizontal

    ::hv3::debug::tree $myTree $HTML

    # The tabs in the right-hand pane:
    ttk::notebook $myReports -width 600
