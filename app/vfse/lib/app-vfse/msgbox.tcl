...
#
# msgbox.tcl --
# Taken from Tk and modified a bit.
#
# The modification supports one additional predefined type
# for the buttons, required by action.tcl
#
# We overwrite the original definition.
...
proc ::tk::MessageBox {args} {
	...
	yesyesallnonoallcancel {
	    set names  [list yes yesall no noall cancel]
	    set labels [list &Yes {Yes to &All} &No {No to All} &Cancel]
	}
	default {
